...
func TestBuildAICheckupPromptMentionsStructuredReport(t *testing.T) {
	...
	for _, expected := range []string{
		...
		"6. Привычки.",
		"10. Зависимости и гипотезы.",
		"11. Три конкретных шага на следующий период.",
		"tool daily_series",
		"пустая клетка означает отсутствие данных, а не ноль",
		"данных меньше 20 дней",
		"Формулируй как гипотезу, а не как факт",
