...
- Задачи и продуктивность берутся из Todoist и Vikunja. Просрочка, план на сегодня и завершённые задачи считай по tasks и task_completions, а не по календарю.
