...
func buildVoiceParsePrompt(candidates []voiceExerciseCandidate, foods []voiceFoodCandidate, projects []taskProject, draft []voiceParsedExercise, workoutOpen bool, now time.Time) string {
	...
	sb.WriteString("- Услышав готовую еду (\"варёные макароны\", \"жареная курица\"), выбирай сырой продукт от производителя, а не чужую запись про готовое: \"Barilla Макароны\", а не \"Макфа Макароны Отварные\"; \"Петелинка Куриное Филе\", а не \"Бахетле Бедро Куриное Жареное\". У сырого КБЖУ с упаковки, у готового - чей-то ручной ввод.\n")
